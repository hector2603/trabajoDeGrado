...
class RedNeuronal(object):
    ...
    def backpropagation1CapaOculta(self,entrenamiento,errorPermitido,entradaDeseada,salidaDeseada,numeroNeuronasCapaOculta):
        ...
        while seguir:
            for i in elementos:
                ...
                #Calculamos el error
                self.generarMatrizDeConfusion(0.2)
    ...
    def generarMatrizDeConfusion(self,porcentajePrueba):
        ...
        for j in elementos:
            ...
            salida,a,b,c = self.RedNeuronal1CapaOculta(entrada, self.pesosCapaOculta, self.pesosCapaSalida)
